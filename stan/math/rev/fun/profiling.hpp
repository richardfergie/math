...
// class profilers {
//   private:
//     std::unordered_map<std::string, profiler_state> profilers_map;
//   public:
//     profiler_state() { }
...
//     // bool forward_pass_running() {
//     //   return forward_pass_running_;
//     // }

//     // bool backward_pass_running() {
//     //   return backward_pass_running_;
//     // }
// };
...
//   std::string id_;
//   profilers_state_map& pp;

//  public:
//   profiler_start_vari(std::string& id, profilers_state_map& p) : id_(id), vari(0), pp(p) {
//     profilers_state_map::iterator it;
//     it = p.find(id);
//     if (it == p.end()) {
...
//  public:
//   profiler_end_vari(std::string& id, profilers_state_map& p) : id_(id), vari(0), pp(p) {
...
//  * @param p map of the states of profilers
//  * @return created var
//  */
// inline var profiler_start(std::string id, profilers_state_map& p) {
...
//  * @return created var
//  */
// inline var profiler_end(std::string id, profilers_state_map& p) {
...
//  * @param p map of the states of profilers
//  */
// inline void profiler_stop(std::string id, profilers_state_map& p) {
//   if (p[id].forward_pass_running()) {
//     p[id].forward_pass_end();
//   }
//   if (p[id].backward_pass_running()) {
//     p[id].backward_pass_end();
//   }
// }
...
//   public:
//   profiler(std::string id, profilers_state_map& p) : id_(id), pp(p) {
