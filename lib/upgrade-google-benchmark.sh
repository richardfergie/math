...
rm -f ../make/*-e
git add -u ../make/*
git commit -m "upgrading to google benchmark v${version}; modifying with new version number"
...
git commit -m "upgrading to google benchmark v${version}; adding google benchmark"
